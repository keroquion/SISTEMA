...
$promos_seed = [
    ...
    [
        ...
        'pantalla' => '14" FHD IPS',
        'precio_regular' => 1500.00,
        'precio_promo' => 1350.00,
        'stock_disponible' => 3,
        'nota_stock' => 'Promo junio L14 11th',
        'descripcion_comercial' => 'Procesador Intel de 11va generación con gráficos Iris Xe y 512GB SSD.'
    ],
    [
        'categoria' => 'LAPTOP_MEDIA',
        'marca' => 'Lenovo',
        'modelo' => 'ThinkPad T14s Gen 2',
        'procesador' => 'Intel Core i5 11th Gen',
        'ram' => '16 GB',
        'almacenamiento' => '512 GB SSD',
        'pantalla' => '14" FHD Slim',
        'precio_regular' => 1550.00,
        'precio_promo' => 1390.00,
        'stock_disponible' => 2,
        'nota_stock' => 'T14s i5 11va Gen',
        'descripcion_comercial' => 'Chasis ultraliviano serie S con procesador de 11va generación.'
    ],
    [
        'categoria' => 'WORKSTATION',
        'marca' => 'Petulap Pro',
        'modelo' => 'CPU Workstation Catálogo #14',
        'procesador' => 'Workstation Extreme Pro',
        'ram' => '32 GB (+S/190 por 64GB)',
        'almacenamiento' => '1 TB NVMe SSD',
        'pantalla' => 'Torre Workstation',
        'precio_regular' => 4200.00,
        'precio_promo' => 3799.00,
        'stock_disponible' => 3,
        'nota_stock' => 'Solo 3 unidades (+S/190 x 32GB extra)',
        'descripcion_comercial' => 'Estación de trabajo pesada para ingeniería, renderizado 3D y simulación.'
    ],
    [
        'categoria' => 'WORKSTATION',
        'marca' => 'Petulap Pro',
        'modelo' => 'CPU Workstation Catálogo #15',
        'procesador' => 'Workstation High Performance',
        'ram' => '32 GB RAM',
        'almacenamiento' => '1 TB SSD',
        'pantalla' => 'Torre Workstation',
        'precio_regular' => 3800.00,
        'precio_promo' => 3490.00,
        'stock_disponible' => 3,
        'nota_stock' => 'Solo 3 unidades en stock',
        'descripcion_comercial' => 'Torre para desarrollo de software, virtualización y diseño arquitectónico.'
    ],
    [
        'categoria' => 'ACCESORIO',
        'marca' => 'TP-Link / Cisco',
        'modelo' => 'Switch de Red Ethernet',
        'procesador' => 'Fast / Gigabit Ethernet',
        'ram' => 'Plug & Play',
        'almacenamiento' => 'N/A',
        'pantalla' => '8 / 16 Puertos',
        'precio_regular' => 140.00,
        'precio_promo' => 100.00,
        'stock_disponible' => 5,
        'nota_stock' => 'Disponible en tienda',
        'descripcion_comercial' => 'Switch de red para interconectar PCs y puntos de red en oficina o taller.'
    ],
    [
        'categoria' => 'ACCESORIO',
        'marca' => 'APC / Forza',
        'modelo' => 'Pack UPS Grado B (Respaldo Eléctrico)',
        'procesador' => 'Regulador y Batería de Respaldo',
        'ram' => 'Estabilizador Integrado',
        'almacenamiento' => 'N/A',
        'pantalla' => 'Indicadores LED',
        'precio_regular' => 500.00,
        'precio_promo' => 350.00,
        'stock_disponible' => 3,
        'nota_stock' => 'Incluye 3 UPS Grado B de regalo adicional',
        'descripcion_comercial' => 'Protección eléctrica continua contra apagones y caídas de tensión.'
    ],
    [
        'categoria' => 'ACCESORIO',
