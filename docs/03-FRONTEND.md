...
| Archivo Identificado | Estado Actual | Diagnóstico, Riesgo y Resolución |
| :--- | :--- | :--- |
| [js/navbar.js](file:///c:/Users/Admin/Desktop/tdf/website_files/js/navbar.js) | **ELIMINADO Y ABSORBIDO (v1.1.0)** | No estaba vinculado desde ninguna pantalla. Contenía versiones viejas de `logout()`, `clearCache()` y `toggleTheme()`. Todo su contenido fue absorbido por `dashboard.js` y el archivo fue retirado de producción (ver [06-REMEDIACION-FRONTEND-PARTE1.md](06-REMEDIACION-FRONTEND-PARTE1.md)). |
| [pedidos_repuestos.html](file:///c:/Users/Admin/Desktop/tdf/website_files/pedidos_repuestos.html) | **100% REMEDIADO (v1.1.0 / v1.4.0)** | Se subsanaron las omisiones previas:<br>1. Se incluyó `check_auth.js` para autenticación y filtrado de roles.<br>2. Se registró el Service Worker PWA (`sw.js`).<br>3. Se sustituyó el menú recortado por la estructura colapsable y de escritorio completa y homogénea con las demás 19 pantallas (ver [10-REMEDIACION-NAVEGACION-MOVIL.md](10-REMEDIACION-NAVEGACION-MOVIL.md)). |
| [desempeno_tecnicos.html](file:///c:/Users/Admin/Desktop/tdf/website_files/desempeno_tecnicos.html) | **100% REMEDIADO (v1.1.0 / v1.4.0)** | Se incorporó `<script src="js/dashboard.js"></script>`, habilitando el despliegue del menú móvil, colapso de barra de escritorio y campana de notificaciones. En `v1.4.0` se incorporó a sí misma dentro de su `#mobile-sidebar` para consistencia absoluta. |
| [admin_roles.html](file:///c:/Users/Admin/Desktop/tdf/website_files/admin_roles.html) | **100% REMEDIADO (v1.2.0)** | Se eliminó la invocación duplicada a `<script src="js/check_auth.js"></script>`, optimizando el ciclo de vida del DOM (ver [07-REMEDIACION-FRONTEND-PARTE2.md](07-REMEDIACION-FRONTEND-PARTE2.md)). |
| `update_roles.php` y `schema_dump.php` | **100% AISLADO (v1.1.0)** | Los scripts de mantenimiento fueron trasladados a `private_scripts/` y eliminados de la raíz pública del servidor web mediante sincronización FTP. |
...
3. **Evolución y Mejoras Ejecutadas:**
   - **Estandarización del Menú Móvil en 20 Pantallas (`v1.4.0` - Resuelto):** Se incorporaron en todas las pantallas los 4 módulos operativos faltantes en smartphones (`pedidos_repuestos.html`, `repuestos.html`, `historial_entregados.html`, `desempeno_tecnicos.html`) y se invalidó el caché con `sw.js` v10 (ver [10-REMEDIACION-NAVEGACION-MOVIL.md](10-REMEDIACION-NAVEGACION-MOVIL.md)).
   - **Estandarización de Pantallas Pendientes (`v1.1.0` - Resuelto):** Enlazado `dashboard.js` en [desempeno_tecnicos.html](file:///c:/Users/Admin/Desktop/tdf/website_files/desempeno_tecnicos.html), protegido [pedidos_repuestos.html](file:///c:/Users/Admin/Desktop/tdf/website_files/pedidos_repuestos.html) con `check_auth.js` y depuración de script duplicado en [admin_roles.html](file:///c:/Users/Admin/Desktop/tdf/website_files/admin_roles.html).
   - **Optimización Responsive Móvil (`v1.2.0` - Resuelto):** Tablas densas transformadas a tarjetas colapsables y apiladas en [lotes.html](file:///c:/Users/Admin/Desktop/tdf/website_files/lotes.html), [reportes.html](file:///c:/Users/Admin/Desktop/tdf/website_files/reportes.html), [inventario.html](file:///c:/Users/Admin/Desktop/tdf/website_files/inventario.html) y kanban móvil en [mis_ordenes.html](file:///c:/Users/Admin/Desktop/tdf/website_files/mis_ordenes.html) (ver [07-REMEDIACION-FRONTEND-PARTE2.md](07-REMEDIACION-FRONTEND-PARTE2.md)).
   - **Próximo Paso Arquitectónico:** A mediano plazo, implementar un generador dinámico de sidebar unificado desde JavaScript para centralizar la definición HTML de los enlaces en un único punto.
